 ...
 */
export function registerGetKnowledgeGraph(server: any, getRootPath: () => string | null, getIsInitialized: () => boolean) {
  server.registerTool(
    'get_knowledge_graph',
    {
